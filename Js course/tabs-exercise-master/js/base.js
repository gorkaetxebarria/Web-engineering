...
/* Remove "hidden" class from all the contents */
...
/* Get clicked element index from id, show related content and hide the rest */
...
/* Get all nav-items and set "current-nav" class only to clicked element */
